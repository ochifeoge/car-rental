...
const HeroSection = () => {
  ...
  return (
    <section
      ...
      <div className="container flex flex-col lg:flex-row justify-center mt-20  items-center  lg:mt-8 lg:h-[calc(100% - 50px)]  ">
        ...
        <form className="text-primary hidden lg:block bg-[rgba(0,0,0,0.5)] p-10 w-[602px] max-w-full backdrop-blur-xs">
